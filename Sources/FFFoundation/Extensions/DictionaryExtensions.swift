...
extension Dictionary {
    ...
    /// - Parameters:
    ///   - lhs: The dictionary in which to merge the `rhs` dictionary.
    ///   - rhs: The dictionary to merge into `lhs`.
    @inlinable
    ...
    /// - Parameters:
    ///   - lhs: The first dictionary to merge.
    ///   - rhs: The second dicitonary to merge.
